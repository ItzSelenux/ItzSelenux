...
let g:colors_name = 'itabyss'
" }}}

" Config {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'itabyss_palette', 'soft')
let s:configuration.transparent_background = get(g:, 'itabyss_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'itabyss_disable_italic_comment', 0)
let s:configuration.enable_italic = get(g:, 'itabyss_enable_italic', 0)
let s:configuration.cursor = get(g:, 'itabyss_cursor', 'auto')
let s:configuration.current_word = get(g:, 'itabyss_current_word', get(g:, 'itabyss_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}

" Palette {{{
let s:palette = {
      \ 'bg0':        ['#2a2a2a',   '0',  'Black'],
      \ 'bg1':        ['#333333',   '0',  'DarkGrey'],
      \ 'bg2':        ['#4a4a4a',   '239',  'DarkGrey'],
      \ 'bg3':        ['#a6a6a6',   '15',  'DarkGrey'],
      \ 'bg4':        ['#a6a6a6',   '15',  'Grey'],
      \ 'bg_red':     ['#2a2a2a',   '0',   'DarkRed'],
      \ 'bg_green':   ['#2a2a2a',   '0',   'DarkGreen'],
      \ 'bg_blue':    ['#2a2a2a',   '0',   'DarkBlue'],
      \ 'fg':         ['#a6a6a6',   '15',  'White'],
      \ 'red':        ['#A66966',   '1',  'Red'],
      \ 'orange':     ['#D78700',   '172',  'Orange'],
      \ 'pink':       ['#CE2662',   '161',  'Pink'],
      \ 'yellow':     ['#A69C66',   '3',  'Yellow'],
      \ 'green':      ['#91a666',   '2',  'Green'],
      \ 'cyan':       ['#66A6AA',   '6',  'Cyan'],
      \ 'blue':       ['#6677A6',   '4',  'Blue'],
      \ 'purple':     ['#9A66A6',   '5',  'Magenta'],
      \ 'purple2':     ['#903696',   '97',  'Mag2'],
      \ 'grey':       ['#363636',   '246',  'LightGrey'],
      \ 'light_grey': ['#555252',   '246',  'LightGrey'],
      \ 'gold':       ['#FFAF00',   '214',  'Yellow'],
      \ 'none':       ['NONE',      'NONE', 'NONE']
      \ }
" }}}
...
call s:HL('StatusLine', s:palette.bg1, s:palette.bg3)
call s:HL('StatusLineTerm', s:palette.bg1, s:palette.bg3)
call s:HL('StatusLineNC', s:palette.bg1, s:palette.bg1)
call s:HL('StatusLineTermNC', s:palette.bg1, s:palette.bg1)
...
call s:HL('Visual', s:palette.bg1, s:palette.fg)
...
" Syntax: {{{
call s:HL('Boolean', s:palette.purple2, s:palette.none)
call s:HL('Number', s:palette.purple2, s:palette.none)
call s:HL('Float', s:palette.purple2, s:palette.none)


  call s:HL('PreProc', s:palette.green, s:palette.none)
  call s:HL('PreCondit', s:palette.pink, s:palette.none)
  call s:HL('Include', s:palette.pink, s:palette.none)
  call s:HL('Define', s:palette.pink, s:palette.none)
  call s:HL('Conditional', s:palette.blue, s:palette.none)
  call s:HL('Repeat', s:palette.blue, s:palette.none)
  call s:HL('Keyword', s:palette.blue, s:palette.none)
  call s:HL('Typedef', s:palette.blue, s:palette.none)
  call s:HL('Exception', s:palette.blue, s:palette.none)
  call s:HL('Statement', s:palette.blue, s:palette.none)


call s:HL('Error', s:palette.red, s:palette.none)
call s:HL('StorageClass', s:palette.blue, s:palette.none, 'bold')
...
call s:HL('Type', s:palette.green, s:palette.none, 'bold')
call s:HL('Function', s:palette.green, s:palette.none, 'bold')
call s:HL('String', s:palette.purple, s:palette.none)
call s:HL('Character', s:palette.purple, s:palette.none)
call s:HL('Constant', s:palette.blue, s:palette.none, 'bold')
call s:HL('Macro', s:palette.pink, s:palette.none)
call s:HL('Identifier', s:palette.blue, s:palette.none)
call s:HL('SpecialKey', s:palette.blue, s:palette.none)

call s:HL('NonText', s:palette.light_grey, s:palette.none)
...
if s:configuration.disable_italic_comment
  ...
  call s:HL('Comment', s:palette.bg2, s:palette.none, 'italic')
...
highlight! link vimFunction Fg
highlight! link vimIsCommand Fg
highlight! link vimUserFunc Fg
highlight! link vimFuncName Fg
...
highlight! link vimSetEqual Green
highlight! link vimSetSep Fg
highlight! link vimOption Fg
highlight! link vimUserAttrbKey Cyan
